...
def organize_screenshots():
    """组织截图文件"""
    source_folder = "App_Store_Screenshots"
    ...
    # 创建组织后的文件夹
    organized_folder = "App_Store_Screenshots_Organized"
...
def create_usage_guide(folder, device_files):
    """创建使用说明"""
    guide_content = """# App Store 截图使用指南
...
- **iPhone_6_7/** - iPhone 6.7" (1290x2796) - 主要展示尺寸
...
### 必需截图
1. **iPhone 截图**: 至少需要 iPhone 6.7" 尺寸
2. **iPad 截图**: 如果支持 iPad，需要 iPad 12.9" 尺寸

### 推荐上传顺序
1. **iPhone_6_7** - 主要展示截图
2. **iPhone_6_5** - 兼容性截图
3. **iPhone_5_5_Plus** - 传统设备截图
4. **iPad_12_9** - iPad支持截图
...
例如：
- `IMG_4857_iPhone_16_Pro_Max_1290x2796.png`
- `IMG_4857_iPad_Pro_12_9_2048x2732.png`

## 🔧 快速选择

### 只上传iPhone版本
使用 `Recommended/iPhone_6_7/` 文件夹中的截图
